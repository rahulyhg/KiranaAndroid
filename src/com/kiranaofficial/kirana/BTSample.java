...
public class BTSample extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	rootView = inflater.inflate(R.layout.activity_bt_sample, container, false);
        ...
        try {
            ...
            if (pairedDevices.size() > 0) {
                for (BluetoothDevice device : pairedDevices) {
                    ...
                    if (device.getName().equals("Windows Phone")) {
                    	uuidDev = device.getUuids()[0].getUuid();
                        mmDevice = device;
                        break;
                    }
                }
    ...
    void openBT() throws IOException {
        try {
            ...
            UUID uuid = UUID.fromString(uuidDev.toString());
