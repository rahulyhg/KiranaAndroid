...
import com.example.karan_pc.kirana.YoFragment;
import com.example.karan_pc.kirana.com.example.karan_pc.kirana.adapters.NavDrawerListAdapter;
...
public class HomeActivity extends FragmentActivity implements ActionBar.OnNavigationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList = (ListView) findViewById(R.id.lvwDrawer);
    ...
    private void LocationFound() {
        Intent i = new Intent(HomeActivity.this, DummyTwoActivity.class);
        startActivity(i);
    }
    ...
    private void displayView(int position) {
        ...
        if (fragment != null) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.homeDrawerFrame, fragment).commit();
